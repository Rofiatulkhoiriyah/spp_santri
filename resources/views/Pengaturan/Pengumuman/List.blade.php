...
@section('pageTitle','List Pengumuman')
  ...
  <div class="card">
    ...
    <div class="card-body">
      <div class="text-right">
        <button type="button" class="btn btn-primary btn-sm btnTambah mb-2"><i class="fas fa-plus"></i> Tambah Pengumuman</button>
      </div>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton{{ $loop->iteration }}">
                        ...
                        <a class="dropdown-item" href="#" onclick="return confirmAlert('/setting/pengumuman/hapus/{{ $list->Oid }}')">
  ...
  <script>
    $(function(){
      ...
      $(".btnTambah").click(function(){
        setForm()
        $("#mdlForm h5").html("Tambah Pengumuman")
        $("#mdlForm").modal("show")
      })

      $(".btnEdit").click(function(){
        const Oid = $(this).data("oid")
        const Url = "/pengumuman/" + Oid 
        ...
        $.ajax({
          ...
          success: function(res) {
            ...
            $("#mdlForm h5").html("Edit Pengumuman")
            $("#mdlForm").modal("show")
